...
//      permission check
        ...
        mSpinTime.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if(tim.equals("Select time")){
                    Toast.makeText(Main2Activity.this, "Please Select time!", Toast.LENGTH_SHORT).show();
                }
                if(tim=="5 sec"){
                    tim= String.valueOf(tim.charAt(0));
                    Toast.makeText(Main2Activity.this, tim+"", Toast.LENGTH_SHORT).show();
                }
                if(tim=="10 sec"){
    ...
    private void enable_button() {
        ...
        mLocationBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                gps = new GPS_Service(Main2Activity.this,tim);
                startService(new Intent(Main2Activity.this,GPS_Service.class));
                ...
                if(gps.canGetLocation()){
                    ...
                    Toast.makeText(Main2Activity.this, latitude+" ::: "+ longitude, Toast.LENGTH_SHORT).show();
                }else{
    ...
    private boolean runtime_permission() {
        if(Build.VERSION.SDK_INT>=23 && ContextCompat.checkSelfPermission(Main2Activity.this, android.Manifest.permission.ACCESS_FINE_LOCATION)!= PackageManager.PERMISSION_GRANTED&& ContextCompat.checkSelfPermission(Main2Activity.this, android.Manifest.permission.ACCESS_COARSE_LOCATION)!=PackageManager.PERMISSION_GRANTED){
